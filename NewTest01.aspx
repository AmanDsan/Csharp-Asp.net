...
<ItemStyle BackColor="#CCCCCC"></ItemStyle>
                 ...
                 <asp:TemplateField HeaderText="Status" HeaderStyle-BackColor="lightskyblue" ItemStyle-BackColor="#CCCCCC" HeaderStyle-HorizontalAlign="Left" Visible="False">
                    <ItemTemplate>
                        <asp:Label ID="lbl_Gender" runat="server" Text='<%#Eval("status") %>'></asp:Label>
                    </ItemTemplate>
