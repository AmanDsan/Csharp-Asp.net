...
public partial class NewTest01 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string queryTeamLead = "Select Distinct Emp_Name,Emp_ID FROM Test";
            ...
            string queryProjectManager = "Select Distinct Reporting_Manager FROM Test";
    ...
    protected void DataSubmit(object sender, EventArgs e)
    {
        ...
        using (SqlCommand cmd = new SqlCommand("TeamData", connec))
        {
            ...
            cmd.Parameters.AddWithValue("@val2", DropDownList1.SelectedItem.Value);
    ...
    /*protected void GridDat()
     {
         //string query = "SELECT a.Emp_Name AS teamlead, a.Reporting_Manager AS projmanager, a.Emp_ID, b.dollarval, b.teamname FROM Test a INNER JOIN tb_teammaster b ON a.Emp_Name = b.teamlead;";
    ...
    protected void GridDat()
    {
        using (SqlConnection connec = new SqlConnection(ConfigurationSettings.AppSettings["ConnectionString"].ToString()))
        {
            ...
            string query = "SELECT a.Emp_Name AS teamlead, a.Reporting_Manager AS projmanager, b.teamname, b.dollarval FROM Test a INNER JOIN tb_teammaster b ON a.Emp_ID = b.teamlead";
            SqlCommand com = new SqlCommand(query, connec);
            SqlDataAdapter adapter = new SqlDataAdapter(com);
            DataTable dt = new DataTable();
            adapter.Fill(dt);
