...
<body>
    ...
    <div class ="cent">
       <table>
           <!-- <asp:Label ID="lblMessage" runat="server" ForeColor="Red"></asp:Label>  Label to show message if data of teamname already exists already exists.--> 
           <tr>
                ...
                <asp:TemplateField HeaderText="Team Name" HeaderStyle-BackColor="lightskyblue" ItemStyle-BackColor="#CCCCCC" HeaderStyle-HorizontalAlign="Left"> 
                     <ItemTemplate>
                            <asp:Label ID="lblTeamName" runat="server" 
                                   Text='<%# Bind("teamname") %>' 
                                   ForeColor='<%# (Eval("teamname").ToString().Contains("(Team name already exists!)")) ? System.Drawing.Color.Red : System.Drawing.Color.Black %>'>
                            </asp:Label>          
                     </ItemTemplate> 
                     <EditItemTemplate>
